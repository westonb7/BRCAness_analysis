...
writefile = open("germline_sub_mutation.tsv", "w")

spazer = 0
counter = 0

writefile.write("Sample ID\tMutation\n")

readfile = open("TCGA_BRCA_Subtypes_Mutations.txt", "r")
...
#		continue
	...
	if counter == 0:
		...
		if (spazer <= 1004):
			writefile.write(str(patient_ID) + "\t" + str(mutation) + "\n")
